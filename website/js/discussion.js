...
const CANVAS_INSTALL_URL = "https://fairmontschools.instructure.com";
...
if(urlParams.has("id")){
    ...
    window.location.href = currentPageUrl+"/liveDiscussion/choose.html";
}
var userId;
...
function initApp(){
    ...
    window.s_websocket = new S_WebSocket('ws://http.speedstor.net:40/socket?socketId='+window.socketId, {
        keepAlive: true,
