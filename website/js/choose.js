window.onload = function(){
    ...
    if(discussionCookie != null && discussionCookie != "null"){
        ...
        var response = fetch("http://speedstor.net:40/listDiscussions?socketId="+window.socketId).then(response => response.json()).then((discussionList) => {
...
function linkTo(urlPath){
    window.location.href = "http://localhost/liveDiscussion/discussion.html?id="+urlPath;
}
...
/*
<div class="item" style="border-bottom: 1px solid grey; border-top: 1px solid grey;">
<li class="list-group-item list-group-item-info">Advanced Coding Languages (H), Sarris, Master</li>
<button class='list-group-item list-group-item-action liveDiscussionOption'>Lorcano Conference <span>choose</span></button>
<button class='list-group-item list-group-item-action liveDiscussionOption'>Lorcano Conference <span>choose</span></button>
<button class='list-group-item list-group-item-action liveDiscussionOption'>Lorcano Conference <span>choose</span></button>
<button class='list-group-item list-group-item-action liveDiscussionOption'>Lorcano Conference <span>choose</span></button>
</div>*/